...
(function () {
    ...
    class DimensionWidgetBuilderPanel extends HTMLElement {
        ...
        set dimension(_dimension) {
            ...
            if (gv_dimension != "" && gv_provider != "") {
                this.fillModel();
                this._shadowRoot.getElementById("builder_provider").value = gv_provider;
                this.fillDimension();
