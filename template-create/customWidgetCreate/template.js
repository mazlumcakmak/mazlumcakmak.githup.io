(function () {
  ...
  class templateCreate extends HTMLElement {
    ...
    init() {
      ...
      this.shadowRoot.getElementById("main_file_type_select").addEventListener("change", this.getJsonFile.bind(this));
    ...
    async downloadFile(filename, jsonText, maiText, builderText) {
